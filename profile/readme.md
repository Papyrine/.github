...
| Project | NuGet | Description |
| --- | --- | --- |
| [Morph](https://github.com/Papyrine/Morph) | [![NuGet](https://img.shields.io/nuget/v/Morph.svg)](https://www.nuget.org/packages/Morph/) | Renders Word `.docx` documents or HTML to PNG images. No Microsoft Word dependency; cross-platform, with SkiaSharp and fully-managed ImageSharp backends. |
